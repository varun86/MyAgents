...
// Source: openclaw/src/plugin-sdk/provider-web-search-config-contract.ts

const _warned = new Set();
function _w(fn) {
  if (!_warned.has(fn)) { _warned.add(fn); console.warn('[sdk-shim] openclaw/plugin-sdk/provider-web-search-config-contract.' + fn + '() not implemented in Bridge mode'); }
}
