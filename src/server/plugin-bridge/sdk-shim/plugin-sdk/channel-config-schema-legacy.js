...
// Source: openclaw/src/plugin-sdk/channel-config-schema-legacy.ts

const _warned = new Set();
function _w(fn) {
  if (!_warned.has(fn)) { _warned.add(fn); console.warn('[sdk-shim] openclaw/plugin-sdk/channel-config-schema-legacy.' + fn + '() not implemented in Bridge mode'); }
}
...
export const DiscordConfigSchema = undefined;
export const GoogleChatConfigSchema = undefined;
export const IMessageConfigSchema = undefined;
export const MSTeamsConfigSchema = undefined;
export const SignalConfigSchema = undefined;
export const SlackConfigSchema = undefined;
export const TelegramConfigSchema = undefined;
export const WhatsAppConfigSchema = undefined;
