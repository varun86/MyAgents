...
impl SidecarManager {
    ...
    /// about to make.
    fn clear_tab_id_from_other_activations(&mut self, keeper_session_id: &str, tab_id: &str) {
...
fn validate_sidecar_runtime_invariant(session_id: &str, sidecar_runtime: Option<&str>, site: &str) {
